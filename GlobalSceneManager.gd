...
func _changeScene_trivia_1920s(): #first trivia, first minigame (bass)
	...
	#res://Objects/Trivia_Scenes/trivia_scenes_blue_gibberish.tscn
func _changeScene_trivia_diff_units(): #second trivia, second minigame (bass)
	get_tree().change_scene_to_file("res://Objects/Trivia_Scenes/trivia_scene_diff_units.tscn")

func _changeScene_trivia_blue_gibberish(): #third trivia, third minigame (bass)
	get_tree().change_scene_to_file("res://Objects/Trivia_Scenes/trivia_scenes_blue_gibberish.tscn")

func _changeScene_trivia_dancers(): #fourth trivia, fourth minigame (bass)
	get_tree().change_scene_to_file("res://Objects/Trivia_Scenes/trivia_scene_dancers.tscn")

func _changeScene_trivia_events(): #fifth trivia, second minigame (snare)
	get_tree().change_scene_to_file("res://Objects/Trivia_Scenes/trivia_scence_events.tscn")

func _changeScene_trivia_introduced(): #sixth trivia, third minigame (snare)
	get_tree().change_scene_to_file("res://Objects/Trivia_Scenes/trivia_scene_introduced.tscn")
